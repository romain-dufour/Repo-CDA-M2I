...
-- question 6
SELECT * FROM livre WHERE auteur = 'agatha christies';
UPDATE 
	livre 
SET 
...
INSERT INTO livre (titre, auteur, editeur, date_publication, isbn_10, isbn_13)
VALUES 
('Dome','Stephen King','format kindle','2009-11-10','2226220585','978-2226220585');

-- question 8


DELETE FROM livre WHERE auteur = 'Edmond Rostand' AND titre = 'Cyrano de Bergerac';
